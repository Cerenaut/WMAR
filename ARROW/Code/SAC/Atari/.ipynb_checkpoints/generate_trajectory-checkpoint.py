...
def evaluate(
    ...
    # Use the same simple sync env and deterministic policy as Coinrun
    ...
    while len(ep_returns) < n_rollouts:
        if wm is None and ac is not None:
            ...
            # WorldModel + AC branch: follow stochastic policy on latent; keep simple for eval
            ...
            _, z, h = wm.rssm(
                ...
                torch.zeros(n_sync, 1, device=z.device),
            )
